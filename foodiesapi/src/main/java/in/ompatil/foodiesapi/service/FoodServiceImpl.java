...
import in.ompatil.foodiesapi.entity.FoodEntity;
import in.ompatil.foodiesapi.io.FoodRequest;
import in.ompatil.foodiesapi.io.FoodResponse;
import in.ompatil.foodiesapi.repository.FoodRepository;
...
public class FoodServiceImpl implements FoodService{
    ...
    public boolean deleteFile(String filename) {
        //checking whether the record is deleting from the aws bucket or not.
